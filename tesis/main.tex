...
\newpage
\include{body/research_scope}
\newpage
\include{body/dataset_description}
\newpage
\include{body/data_preprocessing}
\newpage
% Limitaciones del estudio
% Limitaciones del estudio
% Trabajo realizado
% Analisis de datos
\include{body/data_procesing}
\newpage
%\include{body/training_phase}
%\newpage
\include{body/future_work}
\newpage
\include{body/result_analysis}
\newpage
