...
%Una sugerencia operativa para efectos de este trabajo se referirá a las recomendaciones concretas que mencionan las personas al momento de visitar una atracción turística, alojamiento y/o la plataforma de Tripadvisor misma, de tal forma que busca proveer de una crítica constructiva o destructiva al dueño/dueña del negocio o a la administración de la plataforma misma, con el fin de mejorar la experiencia de los futuros turistas que utilicen los servicios.

Definido por Fabijan et al. (2015) \cite{.............} y  Maalej et al. (2016) \cite{.............} 

Mientras que el feedback explicito resume las opiniones subjetivas de los usuarios, el feedback implícito reune la información de los datos resultantes de la interacción de los usuarios con el producto o servicio, pero interpretables por los analistas, tales como mapas de calor, cantidad de clicks, entre otros datos no provistos por los usuarios de forma directa o intencional, de forma que ayudan a comprender las opiniones subjetivas (feedback explicito) de los usuarios.
