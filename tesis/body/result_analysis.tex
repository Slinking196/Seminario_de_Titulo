...
En esta sección se presentan los resultados obtenidos a partir de la implementación y ejecución del modelo Transformer para el etiquetado de sugerencias sobre el dataset de reseñas turísticas de TripAdvisor\textcite{tripadvisor-website}. Realizaremos un análisis mixto (cualitativo y cuantitativo) de los resultados obtenidos, evaluando datos cuantitativos como la precisión del modelo y datos cualitativos como calidad de las sugerencias identificadas.