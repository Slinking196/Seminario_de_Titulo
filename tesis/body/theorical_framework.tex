...
En esta sección se abordarán temas como la experiencia del usuario (UX), la experiencia del consumidor (CX) y la experiencia del turista (TX), así como sus relaciones, las dimensiones de TX según \cite{kim2012development} y los conceptos técnicos relacionados al proyecto.
...
\section{Sugerencia operativa}
\label{sec:sugerencia_operativa}
